...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '0b781087318447c3a3d92eb2140b6fc5',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi,欢迎来到币圈~糖·豆~分析🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '糖🍬豆', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '币圈策略分享之地，欢迎伙伴到来🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.cz87.eu.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '币圈人的分享网', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '5362331@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  // END ************网站字体*****************
  CAN_COPY: process.env.NEXT_PUBLIC_CAN_COPY || null, // 是否允许复制页面内容 默认允许，如果设置为false、则全栈禁止复制内容。
  ...
  POST_SHARE_BAR_ENABLE: process.env.NEXT_PUBLIC_POST_SHARE_BAR || 'null', // 文章分享功能 ，将在底部显示一个分享条
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://cwz1987.eu.org', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '币圈~糖·豆~分析', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个币圈人的站点', // 站点描述，被notion中的页面描述覆盖
