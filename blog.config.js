...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNext', // 您的昵称 例如 Yitan研究
  BIO: process.env.NEXT_PUBLIC_BIO || '一个币圈讨论网，so：我要吃饭🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'cwz87.EU.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'YItai, 博客', // 网站关键词 英文逗号隔开
